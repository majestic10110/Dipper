...
class DipperModeApp:
    def __init__(self, root):
        self.root = root
        self.root.title("DIPPER V3.2 by M0OLI")
        ...
        self.filter_frame = tk.LabelFrame(self.tx_frame, text="Frequency Filter", fg=self.current_colors["fg"], bg=self.current_colors["bg"])
